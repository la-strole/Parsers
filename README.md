...
### Создание окружения:
1. Пока работа тестировалась только в Linux;
1. Необходим python не ниже 3.5 и `python3.X-venv`;
2. в `start_parsers.sh` отредактировать `path_line` на путь к рабочему каталогу.
